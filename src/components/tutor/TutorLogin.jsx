...
const TutorLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/accounts/tutor_login/",
        {
  ...
  return (
    <div className="bg-teal-700 w-full sm:w-1/2 md:w-1/2 lg:w-1/3 flex flex-col items-center justify-center h-auto p-4 sm:p-6">
      <h1 className="text-3xl sm:text-2xl md:text-3xl lg:text-4xl text-slate-900 mb-4 bg-inherit font-bold">Tutor Login</h1>
